...
def markdown_read(params: list[str]) -> str:
    ...
    try:
        ...
        return json.dumps({"status": "error", "reason": f"Read failed: {e}"})


@directive("tc-markdown", "headings", domain_alias=None, action_aliases={"headings": "标题"})
def markdown_headings(params: list[str]) -> str:
    ...
    try:
        ...
        return json.dumps({"status": "error", "reason": f"Heading extraction failed: {e}"})


@directive("tc-markdown", "section", domain_alias=None, action_aliases={"section": "章节"})
def markdown_section(params: list[str]) -> str:
    ...
    try:
        ...
        return json.dumps({"status": "error", "reason": f"Section extraction failed: {e}"})

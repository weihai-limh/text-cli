...
| **无空格** | 文件名中不使用空格 | ❌ `SPEC v1.0_zh.md` → ✅ `SPEC_v1_0_zh.md` |
| **语言代码** | `_zh`（中文）、`_en`（英文）——紧邻 `.md` 之前 | `Treasury_governance_zh.md` |
| **禁止纯中文文件名** | 文件名不得以中文为主 | ❌ `项目金库使用规范_zh.md` → ✅ `Treasury_governance_zh.md` |
| **大小写** | 英文名称可用 PascalCase 或 snake_case | `Production_TCC_zh.md` / `production_tcc_en.md` |

### 8.3 正确示例

```
docs/ecosystem/
├── Ecological_economy_zh.md          ← 生态经济体系
├── Production_TCC_zh.md             ← TCC 铸造技术方案
├── collaborator-guide_zh.md         ← AI 协作者指南
├── charter_zh.md                    ← 生态宪章
├── collaboration_zh.md              ← 协作规范
└── ...
```

"""
markdown_converter_zh.py — Turn structured Markdown into a text-cli directive service.

Usage:
    python markdown_converter_zh.py <experience-doc.md>
...
if __name__ == "__main__":
    ...
    if not md_path:
        print("Usage: python markdown_converter_zh.py <experience-doc.md> [--port <N>] [--host <addr>]")
        print("Example: python markdown_converter_zh.py 盆栽急救手册_zh.md --port 9000")
        sys.exit(1)

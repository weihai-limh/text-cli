"""
markdown_converter_en.py — Turn structured Markdown into a text-cli directive service.

Usage:
    python markdown_converter_en.py <experience-doc.md>
...
Markdown format:
    ...
    #### <sub-category>
    Content lines...
    Convention fields inside content: Differential (how to distinguish from similar issues), Lessons (hard-earned lessons)
"""
...
if __name__ == "__main__":
    ...
    if not md_path:
        print("Usage: python markdown_converter_en.py <experience-doc.md> [--port <N>] [--host <addr>]")
        print("Example: python markdown_converter_en.py Bonsai-First-Aid-Manual_en.md --port 9000")
        sys.exit(1)

...
SQLite module present → local processing
SQLite module absent → routed to copilot via proxy_routes.json (no handler registered)
"""
...
try:
    ...
    logger.info("SQLite module not installed, key directives proxied")

...
端点 A:
  {"基础应用;天气查询": {"description": "...", "params": 3},
   "基础应用;穿衣标签": {"description": "...", "params": 3}}

端点 B:
  {"基础应用;天气查询": {"description": "...", "params": 3},
   "基础应用;百度搜索": {"description": "...", "params": 2}}

聚合后（指令优先格式，写入 agent-text-cli-schema.json）：
{
  "directives": {
    "基础应用;天气查询": [
      {"endpoint": "端点A的url", "rank": 2, ...},
      {"endpoint": "端点B的url", "rank": 1, ...}
    ],
    "基础应用;穿衣标签": [
      {"endpoint": "端点A的url", "rank": 1, ...}
    ],
    "基础应用;百度搜索": [
      {"endpoint": "端点B的url", "rank": 1, ...}
    ]
